...
- why we use canvasContainerRef
  - Canvas resizing is difficult hence we are using a div as canvasContainerRef and we will use a resize observer to see if 
    canvasContainerRef is resized and use the width and height from there to set width and height of canvas
